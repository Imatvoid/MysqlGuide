...
![1567315250559](assets/innodb数据页结构/1567315250559.png)
...
![img](assets/innodb数据页结构/16a3e5782ca4a346)
...
![img](assets/innodb数据页结构/16a3e5782c944eaf)
...
![img](assets/innodb数据页结构/16a3e5782fc0ef6a)
...
![img](assets/innodb数据页结构/16a3e5783051dd99)
...
![img](assets/innodb数据页结构/16a3e578f1f81d0f)
...
InnoDB`的大叔们为我们的记录也制作了一个类似的目录，他们的制作过程是这样的：
...
![img](assets/innodb数据页结构/16a3e5790b3e26c2)
...
![img](assets/innodb数据页结构/16a3e57926e95943)
...
- `FIL_PAGE_PREV`和`FIL_PAGE_NEXT`
  ...
  ![img](assets/innodb数据页结构/16a3e579271b492f)
